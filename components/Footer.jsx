...
export default function Footer() {
  return (
    <div class="grid grid-cols-1 md:grid-cols-4 md:place-items-center lg:place-items-stretch lg:grid-cols-5 gap-20 py-20 px-20 h-full lg:h-[350px] bg-gray-50">
        <div class="flex flex-col col-span-2 text-left justify-between md:space-y-5 lg:space-y-0 h-full">
           <div class="flex flex-col space-y-3">
                <img src="/logo-1.png" class="w-1/3" />
                <p class="text-xs w-2/3 text-black/70">Lorem ipsum dolor sit amet consectetur adipisicineserune fugit quo modi enim molestiae corporis? Id, beatae deleniti accusantium ad enim rem itaque magni dolore ratione labore quaerat aliquam iure perferendis.</p>
           </div>
        ...
        <div class="flex flex-col items-center w-full h-full justify-between space-y-10 lg:space-y-0  md:col-span-5 lg:col-span-1">
            ...
            <div class="relative flex items-center border border-gray-400 rounded w-full">
                <span class="hidden md:flex absolute text-center w-full -top-7 text-[10px] text-black/70">S'abonnez a notre newsletter</span>
