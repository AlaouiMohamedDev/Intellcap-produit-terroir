  ...
  return (
    <div class="font-poppins">
        ...
        <div class="bg-cooperative space-y-4 bg-cover bg-center w-full flex flex-col items-center justify-center text-white relative h-1/3">
            ...
            <div class="z-20 w-[65%] cursor-pointer flex flex-col md:flex-row space-y-3 md:space-y-0 items-center rounded py-7 text-white space-x-5 px-5">
                <img src="/cooperative/coop-2.png" class="object-cover w-[150px] h-[150px] border-2 border-white p-2 rounded-full" />
                <div class="flex flex-col w-full space-y-5">
                    <div class="flex items-center justify-between">
                        <h1 class="text-xl font-bold">Cooperative Taliouine</h1>
                    
                    </div>
                <p class="text-sm text-gray-300">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa eius officiis hic quia! Nobis, cupiditate.</p>
                <div class="flex items-center space-x-8">
                    <div class="flex items-center text-xs space-x-2 text-main bg-white py-1 px-2 w-max rounded">
                        <i class='bx bx-calendar-check'></i>
                        <span class="">16 Decmber 2022</span>
                    </div>
                    <span class="text-xs text-main bg-white py-1 px-2 rounded w-max">10 produits</span>
                </div>
            </div>
            </div>
        </div>
